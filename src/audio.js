...
function sceneAudioArenaLike(){
  return G.state==="cinematic"||G.state==="round"||G.state==="roundend"||G.state==="tiebreak"||G.state==="battle"||G.state==="battleend"||G.state==="rackrush"||G.state==="rushintro"||G.state==="rushbetween"||G.state==="rushend"||G.state==="wincine"||G.state==="replay";
}
...
function toggleMute(){
  ...
  const arenaLike=G.state==="cinematic"||G.state==="round"||G.state==="tiebreak"||G.state==="battle"||G.state==="rackrush"||G.state==="rushintro"||G.state==="rushbetween";
  try{
    const s=audioState();
