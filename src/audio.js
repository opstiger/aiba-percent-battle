...
const EN_SPEECH=Object.freeze({
  "三分线外是我的地盘。":"This is my house! You out of bounds!",
  "今晚我让你两个花球。":"Spotting you two money balls. Easy money sniper!",
  "方块小子,回家再练十年。":"Practice? We talkin' about practice?!",
  "我闭着眼都比你准。":"Blindfolded! I can do this blindfolded!",
  "听到观众在喊谁的名字了吗?":"Hear that? They screaming MVP!",
  "希望你的手别抖。":"Don't choke! The Mailman don't deliver on Sundays!",
  "运气球罢了…":"Pure luck! Lucky bounce!",
  "风!刚才一定有风!":"Turn the AC off! Man, it's windy in here!",
  "裁判!他踩线了吧?!":"Ref, check his feet! He stepped out!",
  "别得意,还没结束。":"Job's not finished! What is there to be happy about?!",
  "……他什么时候变这么准的?":"Yo, since when does he cash that? Unbelievable!",
  "我热身还没做完而已。":"That was just warmups, kid. Real game starts now.",
  ...
  "快追啊!":"Keep that same energy! Catch up!",
  "就这点本事?":"Is that all you got? Soft! You soft!",
  "我已经看到终点了!":"Check the scoreboard, kid! Check it!",
  "你还差得远呢!":"You're too small! Weight room!",
  "100分是我的!":"Night night! Put 'em to sleep!",
  "看好了,这才叫投篮。":"Watch closely! Splash! Splash brother style!",
  "我会让你知道差距。":"And I took that personally! Watch me!",
  "记好这个分数。":"Count the rings, kid! Check the score!",
  "反超!比分易主!":"Lead change!",
  ...
  "就这?":"Soft! Y'all are soft!",
  "就这？":"Soft! Y'all are soft!",
  "我奶奶都比你稳。":"My grandma got a better jumper than that!",
  "手抖了啊兄弟。":"Stop it. Get some help!",
  "要不要借你我的发带?":"You sweating? Need to borrow my headband?",
  "要不要借你我的发带？":"You sweating? Need to borrow my headband?",
  "观众都替你尴尬了。":"Brick! Westbrick! Oh my god!"
});
