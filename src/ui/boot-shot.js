...
const WALK_DUR=1.9;        // 自己控时长:比 walkTo 按距离算出来的慢,像入场而不是赶路
const CINE=[
  ...
  {t:2.45,pos:[ 0.10,0.98,3.02],look:[0,2.45,-8],fov:69},  // 人物贴着镜头右侧切进画面
  {t:3.45,pos:[ 0.55,1.30,2.68],look:[0,2.95,-8],fov:66}   // 落定:右肩后方
];
