...
const root=path.resolve(path.dirname(fileURLToPath(import.meta.url)),'..'),out=path.join(root,'artifacts/court-density-20260910');fs.mkdirSync(out,{recursive:true});
